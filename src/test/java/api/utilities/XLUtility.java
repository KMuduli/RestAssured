...
public class XLUtility {
	...
	public String getCellData(String sheetName, int rownum, int colnun) throws IOException
	{
		fi=new FileInputStream(path);
		workbook=new XSSFWorkbook(fi);
		sheet=workbook.getSheet(sheetName);
		row=sheet.getRow(rownum);
		cell=row.getCell(colnun);
	...
	public void setCellData(String sheetName, int rownum, int colnun, String data) throws IOException
	{
